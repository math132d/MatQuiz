<template>
  <div class="quiz fill aligner aligner--col aligner--space">
    ...
    <div class="aligner aligner--row" style="padding: 8px;">
      ...
      <button @click="verifyQuestion" class="verifyer aligner button" :class="{'button-primary': isVerified!==0, 'button-warning': isVerified===0}" :disabled="isDone===true" style="margin-right: 16px;" >
      ...
      <button @click="nextQuestion" class="aligner button" :class="{'button-primary': isVerified===1, 'button-secondary': isVerified!==1}" :disabled="isVerified===-1" >
